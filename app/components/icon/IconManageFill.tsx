...
const IconManageFill: FunctionComponent<Props> = ({size, color, ...rest}) => {
  return (
...
IconManageFill.defaultProps = {
  size: 24,
};

export default React.memo ? React.memo(IconManageFill) : IconManageFill;
